...
$breadcrumbs = [
    'Pacientes' => '../pacientes/listar.php',
    $paciente['nombre'] . ' ' . $paciente['apellidos'] => '../pacientes/editar.php?id=' . $paciente_id,
    'Enviar Consentimiento' => '#'
];
...
<div class="container-fluid py-4 px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?= BASE_URL ?>/modules/pacientes/editar.php?id=<?= $paciente_id ?>" class="btn btn-outline-secondary">
        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body text-center p-5">
                    ...
                    <div class="mt-4">
                        <a href="<?= BASE_URL ?>/modules/pacientes/editar.php?id=<?= $paciente_id ?>" class="btn btn-primary">
                            <span class="material-symbols-rounded me-2">arrow_back</span>Volver al Paciente
                        </a>
