...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Normalizar tamaño de iconos en el sidebar
    const sidebarIcons = document.querySelectorAll('.sidebar-icon');
    sidebarIcons.forEach(icon => {
        // Asegurar tamaño consistente para iconos del sidebar
    ...
    // Normalizar iconos en botones
    document.querySelectorAll('.btn .material-symbols-rounded, .btn .material-symbols-outlined').forEach(icon => {
        if (!icon.classList.contains('icon-lg') && !icon.classList.contains('icon-sm') && !icon.classList.contains('icon-xl') && !icon.classList.contains('icon-xs')) {
            icon.classList.add('icon-md');
        }
    });
    
    // Asegurar que todos los iconos tengan el mismo tamaño según sus clases
    document.querySelectorAll('.material-symbols-rounded, .material-symbols-outlined').forEach(icon => {
        // Si no tiene ninguna clase de tamaño específica, aplicar tamaño predeterminado
        if (!icon.classList.contains('icon-lg') && !icon.classList.contains('icon-sm') && !icon.classList.contains('icon-xl') && !icon.classList.contains('icon-xs') && !icon.classList.contains('icon-md') && !icon.classList.contains('sidebar-icon')) {
            icon.classList.add('icon-md');
        }
    });
});
...
document.addEventListener('DOMContentLoaded', function() {
    // Inicializa todos los dropdowns del sidebar
    ...
    // Resaltar elemento activo basado en la URL actual
    const currentPath = window.location.pathname;
    const sidebarLinks = document.querySelectorAll('.sidebar-sublink, .sidebar-link');
